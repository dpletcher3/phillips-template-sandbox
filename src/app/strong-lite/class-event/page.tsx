...
/* ── Page Component ────────────────────────────────── */
export default function ClassEventLitePage() {
    ...
    <div style={{ background: L_BG, minHeight: '100vh' }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          {/* Right — Filter Pills (dark context inside hero) */}
      ...
      <FinalCTA
        tag="// Training Calendar"
        headline="Ready to level up your skills?"
        accentWord="your skills?"
        description="Browse our full class calendar and register for upcoming CNC training sessions across the Mid-Atlantic region."
      />
    </div>
  )
}
