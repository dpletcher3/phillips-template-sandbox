...
import DarkAccent from '@/components/strong-lite/DarkAccent'
...
/* Dark tokens (hero + dark accent sections) */
const Z_BG      = '#09090B'
...
/* ═══════════════════════════════════════════
   PAGE COMPONENT
   ═══════════════════════════════════════════ */
export default function StrongLiteProductLinePage() {
  ...
  return (
    <div style={{ background: L_BG, color: L_INK, minHeight: '100vh' }}>
      ...
      {/* ─── 3. PRODUCT LINE FILTER TABS (LIGHT) ─── */}
      <div style={{
      ...
      {/* 4a — SERIES HEADER (LIGHT) */}
      <section style={{ background: L_BG, padding: '72px 48px 0' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <LiteEye label={panel.series} />
          <div style={{
            ...
            <div style={{ flex: '1 1 60%' }}>
              <h2 style={{
                ...
                color: L_INK, margin: '0 0 14px',
              }}>
                {panel.title}
              </h2>
              <p style={{
                color: L_DIM, fontSize: '14px', lineHeight: 1.7,
      ...
      {/* 4b — MODEL CARDS (LIGHT) */}
      <section style={{ background: L_BG, padding: '48px 48px 0' }}>
        <div style={{
          ...
          {panel.cards.map(card => (
            <div key={card.model} style={{
              ...
              background: L_SURFACE,
              border: `1px solid ${L_BORDER}`,
              borderTop: card.featured ? `2px solid ${RED}` : `1px solid ${L_BORDER}`,
              borderBottom: card.featured ? `2px solid ${RED}` : `1px solid ${L_BORDER}`,
              padding: '28px 24px',
              ...
              {card.badge && (
                <span style={{
                  alignSelf: 'flex-start',
                  background: card.featured ? 'rgba(249,66,58,.08)' : L_CARD,
                  color: card.featured ? RED : L_MID,
                  fontFamily: MONO, fontSize: '8px', fontWeight: 700,
                  letterSpacing: '2px', textTransform: 'uppercase' as const,
                  padding: '4px 10px',
                  border: `1px solid ${card.featured ? 'rgba(249,66,58,.25)' : L_BORDER}`,
                }}>
                  {card.badge}
                </span>
              )}
              ...
              <div style={{
                ...
                letterSpacing: '0.5px', color: L_DIM,
      ...
      {/* 4c — TRAVEL BARS (LIGHT) */}
      <section style={{ background: L_BG, padding: '64px 48px 0' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <LiteEye label="Travel Comparison" />
      ...
      <section style={{
        ...
        <div style={{
          ...
          background: `radial-gradient(circle, rgba(249,66,58,.06) 0%, transparent 70%)`,
          pointerEvents: 'none',
        }} />
      ...
      <section style={{
        ...
        <button style={{
          background: 'transparent', color: L_INK,
          border: `1px solid ${L_BORDER}`,
          padding: '13px 30px', fontFamily: MONO,
          fontSize: '10px', fontWeight: 700, letterSpacing: '2px',
          textTransform: 'uppercase' as const, cursor: 'pointer',
