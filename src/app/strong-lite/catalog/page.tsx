    ...
    <div style={{ background: L_BG, color: L_INK, minHeight: '100vh' }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          {/* RIGHT — Stat callouts (dark hero context) */}
      ...
      {/* ── 3. FILTER TABS (light bg, dark text) ────── */}
      <div style={{
        position: 'sticky',
        top: 58,
        zIndex: 50,
        ...
        {FILTER_TABS.map((tab) => (
          <button
            ...
            style={{
              ...
              color: activeFilter === tab.key ? RED : L_MID,
              fontFamily: MONO,
              fontSize: '10px',
              fontWeight: 700,
              letterSpacing: '2px',
      ...
      {/* ── 4. COURSE CARD GRID (light bg, white cards) */}
      <section style={{
        padding: '32px 48px',
        background: L_BG,
      }}>
        <div style={{
          ...
          {filteredCourses.map((course) => (
            <div
              ...
              style={{
                background: L_WHITE,
                border: course.isMostPopular ? `1px solid ${RED}` : `1px solid ${L_BORDER}`,
                borderTop: course.isMostPopular ? `2px solid ${RED}` : `1px solid ${course.isMostPopular ? RED : L_BORDER}`,
                padding: '20px',
                display: 'flex',
      ...
      {/* ── 5. TESTIMONIAL STRIP (light bg, dark text) ─ */}
      <section style={{
        background: L_CARD,
        borderTop: `1px solid ${L_BORDER}`,
        padding: '40px 48px',
