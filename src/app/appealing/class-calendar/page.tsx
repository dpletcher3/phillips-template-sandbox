...
import AppealingClassCalendarClient from '@/components/templates-appealing/class-calendar/AppealingClassCalendarClient'
...
export default async function ClassCalendarPage() {
  ...
  return <AppealingClassCalendarClient data={data} />
}
