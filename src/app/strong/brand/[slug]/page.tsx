...
import DarkSection from '@/components/strong/DarkSection'
import DarkEye from '@/components/strong/DarkEye'
import DataStrip from '@/components/strong/DataStrip'
...
/* ── Page Component ────────────────────────────────── */
export default function StrongBrandPage() {
          ...
          {SPEC_CARDS.map((card, i) => {
            ...
            return (
              <div
                ...
                style={{
                  background: isActive ? Z_CARD : Z_SURFACE,
                  padding: '28px 24px',
                  cursor: 'pointer',
                  borderTop: isActive ? `2px solid ${RED}` : '2px solid transparent',
          ...
          {FEATURE_PANELS.map((panel, i) => {
            ...
            return (
              <div
                ...
                style={{
                  background: isHovered ? Z_CARD : Z_SURFACE,
                  borderBottom: isHovered ? `2px solid ${RED}` : '2px solid transparent',
          ...
          {COMPARE_MACHINES.map((m, i) => {
            ...
            return (
              <div
                key={i}
                style={{
                  background: isFeatured ? Z_CARD : Z_SURFACE,
                  borderTop: isFeatured ? `2px solid ${RED}` : '2px solid transparent',
                  padding: '0',
                  transition: 'all .25s ease',
                }}
              >
                ...
                <div style={{ padding: '24px' }}>
                  ...
                  <button style={{
                    ...
                    color: isFeatured ? '#fff' : Z_BRIGHT,
                    border: isFeatured ? 'none' : `1px solid rgba(255,255,255,.2)`,
                    padding: '12px 0',
                    fontFamily: MONO,
                    fontSize: '10px',
                    fontWeight: 700,
            ...
            return (
              ...
              >
                <Image
                  ...
                  style={{
                    objectFit: 'cover',
                    filter: isHov ? 'brightness(.7)' : 'brightness(.5)',
