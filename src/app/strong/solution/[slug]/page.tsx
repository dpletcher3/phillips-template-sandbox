...
/* ── Page ───────────────────────────────────────────── */
export default function StrongSolutionPage() {
  return (
    <div style={{ background: Z_BG, color: Z_BRIGHT, minHeight: '100vh' }}>
      ...
      {/* ── 4. CAPABILITY BARS ──────────────────────── */}
      <DarkSection>
        <DarkEye label="Capability Range" />
        <h2 style={{
          fontFamily: INTER,
          fontWeight: 900,
      ...
      {/* ── 5. INDUSTRY GRID ────────────────────────── */}
      <DarkSection style={{ background: Z_SURFACE }}>
        <DarkEye label="Industries We Serve" />
        <h2 style={{
          fontFamily: INTER,
          fontWeight: 900,
          fontSize: 'clamp(28px, 3.5vw, 42px)',
          ...
          {INDUSTRIES.map((ind) => (
            ...
            >
              ...
              <div style={{
                position: 'absolute',
                inset: 0,
                background: 'linear-gradient(180deg, transparent 20%, rgba(9,9,11,0.85) 100%)',
                zIndex: 1,
              }} />
            ...
            <div style={{
              ...
              {SERVICES.map((svc) => (
                <div
                  ...
                  onMouseLeave={(e) => {
                    (e.currentTarget as HTMLDivElement).style.borderLeftColor = Z_BORDER
                  }}
                >
                  <h4 style={{
                    fontFamily: INTER,
